        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              Professional platform for discovering, managing, and sharing
              cutting-edge AI models worldwide.
            </p>
            <div className="flex gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-9 h-9 bg-gray-800 hover:bg-blue-400 rounded-xl flex items-center justify-center transition-colors"
              >
                <FaTwitter size={16} />
              </a>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-9 h-9 bg-gray-800 hover:bg-blue-700 rounded-xl flex items-center justify-center transition-colors"
              >
                <FaLinkedin size={16} />
              </a>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              ...
              <li>
                <Link to="/models" className="hover:text-white transition">
                  Explore Models
                </Link>
              </li>
              <li>
                <Link to="/add-model" className="hover:text-white transition">
                  Add Model
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              ...
              <li className="flex items-center gap-2">
                <MapPin size={14} className="text-blue-400 flex-shrink-0" /> San
                Francisco, CA
              </li>
              <li className="flex items-center gap-2">
                <Phone size={14} className="text-blue-400 flex-shrink-0" /> +1
                (555) 000-0000
              </li>
            </ul>
          </div>
